const regions = [
    ...
    },
    {
        ...
        places: [
            ...
            { id: 8, name: "Bodrum Kalesi", city: "Mugla", category: "Tarihi Yapi", image: "https://picsum.photos/seed/bodrum/800/400", description: "St. Jean Senovalyeleri tarafindan insa edilen Bodrum Kalesi, gunumuzde Su Alti Arkeoloji Muzesi'ne ev sahipligi yapmaktadir.", accommodation: "Bodrum merkezde ve cevresinde her butceye uygun otel bulunur. Marina Vista Hotel, Bodrum Kaya Otel ve Artemis Otel kaleye yakin konaklama noktalaridir." }
        ]
    },
    {
        name: "Ic Anadolu",
