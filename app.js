const regions = [
    {
        name: "Marmara", icon: "???",
        places: [
            { id: 1, name: "Ayasofya", city: "Istanbul", category: "Tarihi Yapi", image: "https://upload.wikimedia.org/wikipedia/commons/d/d0/Hagia_Sophia_Mars_2013.jpg", description: "Bizans mimarisinin basyapiti, dunyanin en etkileyici tarihi yapilarindan biri. Ayasofya, Istanbul'un sembolu haline gelmis ve yuzyillar boyunca hem kilise hem cami olarak kullanilmistir.", accommodation: "Sultanahmet bolgesinde cok sayida butik otel ve pansiyon bulunur. En yakin konaklama secenekleri arasinda Sultanahmet Kureli Hotel, Celal Sultan Hotel ve Yesil Ev gibi tarihi oteller yer alir." },
            { id: 2, name: "Topkapi Sarayi", city: "Istanbul", category: "Tarihi Yapi", image: "https://upload.wikimedia.org/wikipedia/commons/a/ac/Topkapi_Palace_Seen_From_Harem.JPG", description: "Osmanli padisahlarinin ikametgahi ve yonetim merkezi. Topkapi Sarayi, 400 yil boyunca Osmanli Imparatorlugu'nun kalbi olmustur.", accommodation: "Saraya en yakin konaklama Sultanahmet ve Sirkeci bolgesindedir. Ibrahim Pasa Hotel, Seven Hills Hotel ve Hagia Sofia Mansions iyi seceneklerdir." },
            { id: 3, name: "Sultanahmet Camii", city: "Istanbul", category: "Tarihi Yapi", image: "https://upload.wikimedia.org/wikipedia/commons/2/22/Sultan_Ahmed_Mosque_in_Istanbul.jpg", description: "Mavi Camii olarak da bilinen Sultanahmet Camii, 6 minaresi ve muhtesem ic dekorasyonuyla Istanbul'un en ikonik yapilarindan biridir.", accommodation: "Sultanahmet Meydani cevresi konaklama icin en ideal bolgedir. Arcadia Blue Hotel, Sultanhan Hotel ve Dervish Hotel yakindaki otellerdendir." },
            { id: 4, name: "Yerebatan Sarnici", city: "Istanbul", category: "Tarihi Yapi", image: "https://upload.wikimedia.org/wikipedia/commons/1/13/The_Basilica_Cistern_Yerebatan_Sarnici%2C_Istanbul%2C_Turkey_%289603495227%29.jpg", description: "Bizans imparatoru I. Justinianus tarafindan yaptirilan bu yeralti sarnici, 336 sutunu ve Medusa baslariyla unlu bir tarih hazinesidir.", accommodation: "Sultanahmet'teki otellerin cogu Yerebatan Sarnicina yurume mesafesindedir. Basilica Residence ve Antusa Hotel en yakin konaklama noktalarindandir." }
        ]
    },
    {
        name: "Ege", icon: "??",
        places: [
            { id: 5, name: "Efes Antik Kenti", city: "Izmir", category: "Arkeoloji", image: "https://upload.wikimedia.org/wikipedia/commons/a/a1/Ephesus_%28Efes%29_Antik_Kenti.jpg", description: "Roma doneminden kalma iyi korunmus antik kent ve kutuphane. Efes, antik dunyanin en onemli ticaret merkezlerinden biriydi.", accommodation: "Selcuk ilcesinde butik otel ve pansiyonlar mevcuttur. AyaSultan Hotel, Nilya Hotel ve Bella Hotel populer konaklama secenekleridir." },
            { id: 6, name: "Pamukkale", city: "Denizli", category: "Dogal Alan", image: "https://upload.wikimedia.org/wikipedia/commons/d/de/Pamukkale_30.jpg", description: "Traverten teraslari ve termal sulariyla unlu doga harikasi. Pamukkale'nin beyaz travertenleri ve antik havuzlari her yil milyonlarca turisti agirlamaktadir.", accommodation: "Pamukkale koyunde ve Karahayit bolgesinde termal oteller bulunur. Pamukkale Thermall, Richmond Pamukkale Thermal ve Colossae Thermal Hotel en iyi seceneklerdendir." },
            { id: 7, name: "Alacati", city: "Izmir", category: "Dogal Alan", image: "https://upload.wikimedia.org/wikipedia/commons/0/03/Cesme_-_Alacati_Marina_-_panoramio.jpg", description: "Tas evleri, dar sokaklari ve ruzgar sorfuyle unlu olan Alacati, Ege'nin en guzel sahil kasabalarindan biridir.", accommodation: "Alacati'da tas ev butik oteller cok populer. Alacati Port Hotel, Mayla Alacati Hotel ve Gaia Alacati otantik konaklama deneyimi sunar." },
            { id: 8, name: "Bodrum Kalesi", city: "Mugla", category: "Tarihi Yapi", image: "https://upload.wikimedia.org/wikipedia/commons/0/05/TurkeyBodrumCastle.jpg", description: "St. Jean Senovalyeleri tarafindan insa edilen Bodrum Kalesi, gunumuzde Su Alti Arkeoloji Muzesi'ne ev sahipligi yapmaktadir.", accommodation: "Bodrum merkezde ve cevresinde her butceye uygun otel bulunur. Marina Vista Hotel, Bodrum Kaya Otel ve Artemis Otel kaleye yakin konaklama noktalaridir." }
        ]
    },
    {
        name: "Ic Anadolu", icon: "???",
        places: [
            { id: 9, name: "Kapadokya", city: "Nevsehir", category: "Dogal Alan", image: "https://upload.wikimedia.org/wikipedia/commons/e/e4/Fairy_Chimneys%2C_Nev%C5%9Fehir_Province%2C_Turkey.JPG", description: "Peri bacalari ve balon turlariyla unlu essiz bir dogal wonderland. Kapadokya, volkanik tuf tabakalarinin erozyonuyla olusmus buyuleyici bir manzaraya sahiptir.", accommodation: "Kapadokya'da kaya oteller ve magara oteller unlu. Museum Hotel, Argos in Cappadocia, Sultan Cave Suites ve Kelebek Cave Hotel en luks seceneklerdendir." },
            { id: 10, name: "Anitkabir", city: "Ankara", category: "Tarihi Yapi", image: "https://upload.wikimedia.org/wikipedia/commons/8/86/Anitkabir_Mausoleum_Ataturk.JPG", description: "Mustafa Kemal Ataturk'un anit mezari. Anitkabir, Ankara'da yukselen bir tepenin uzerinde, gorkemli bir yapidir.", accommodation: "Ankara merkezde Anitkabir'e yakýn cok sayida otel vardir. Ankara HiltonSA, Divan Ankara ve The Green Park Ankara en bilinenlerdir." },
    ...
    },
    {
        name: "Akdeniz", icon: "??",
        places: [
            { id: 12, name: "Olimpos", city: "Antalya", category: "Arkeoloji", image: "https://upload.wikimedia.org/wikipedia/commons/7/7a/Olympos_Antik_Kenti.jpg", description: "Likya doneminden kalma antik kent ve caretta caretta kaplumbagalarinin yumurtladigi sahiliyle unlu bir tatil beldesidir.", accommodation: "Olimpos'ta agac evler unlu bir konaklama deneyimi sunar. Olimpos Lodge, Kadir'in Agac Evleri ve Sait's Place butik ve dogal konaklama imkani saglar." },
            { id: 13, name: "Aspendos", city: "Antalya", category: "Arkeoloji", image: "https://upload.wikimedia.org/wikipedia/commons/0/0b/Theatre_Aspendos.jpg", description: "Antik donemden kalma en iyi korunmus tiyatrolardan biri olan Aspendos, 15.000 kisi kapasiteli muhtesem bir yapidir.", accommodation: "Aspendos'a en yakin konaklama Serik ve Side bolgesindedir. Kaya Aspendos Hotel, Crystal Admiral Resort ve Side otelleri iyi seceneklerdir." },
            { id: 14, name: "Duden Selalesi", city: "Antalya", category: "Dogal Alan", image: "https://upload.wikimedia.org/wikipedia/commons/f/ff/Lower_Duden_Falls.jpg", description: "Antalya sehrinin icinden gecen Duden Cayi'nin denize dokuldugu noktada olusan muhtesem bir selaledir.", accommodation: "Antalya sehir merkezinde Duden Selalesi'ne yakin oteller bulunur. Ramada Plaza Antalya, DoubleTree by Hilton Antalya ve IC Hotels Airport iyi seceneklerdir." }
        ]
    },
    {
        name: "Karadeniz", icon: "??",
        places: [
            { id: 15, name: "Uzungol", city: "Trabzon", category: "Dogal Alan", image: "https://upload.wikimedia.org/wikipedia/commons/7/7e/Uzung%C3%B6l_lake_and_town.jpg", description: "Yesilin her tonunu barindiran doga harikasi Uzungol, yemyeþil daglarla cevrili huzur veren bir gol kenari tatil beldesidir.", accommodation: "Uzungol cevresinde gol manzarali oteller ve butik daireler bulunur. Uzungol Park Hotel, Karadeniz Resort Otel ve Ada Otel en populer konaklama noktalaridir." },
            { id: 16, name: "Sumela Manastiri", city: "Trabzon", category: "Tarihi Yapi", image: "https://upload.wikimedia.org/wikipedia/commons/d/db/Sumela_From_Across_Valley.JPG", description: "Kayalarin oyulmasiyla insa edilen bu tarih manastir, Karadeniz'in en onemli turistik noktalarindan biridir.", accommodation: "Sumela Manastiri'na en yakin konaklama Macka ilcesinde bulunur. Sumela Park Hotel, Macka Senler Otel ve Trabzon sehir merkezindeki oteller tercih edilebilir." },
            { id: 17, name: "Ayder Yaylasi", city: "Rize", category: "Dogal Alan", image: "https://upload.wikimedia.org/wikipedia/commons/b/b7/Ayder_Yaylasi_%40_Rize-Turkey.JPG", description: "Kaplicalari, yayla evleri ve muhtesem dogasiyla unlu olan Ayder Yaylasi, Karadeniz'in incilerinden biridir.", accommodation: "Ayder Yaylasi'nda dogal ahsap oteller ve kaplica otelleri bulunur. Ayder Otel, Yesil Vadi Otel ve Kardelen Otel termal konaklama imkani sunar." }
        ]
    },
    {
        name: "Dogu Anadolu", icon: "??",
        places: [
            { id: 18, name: "Van Golu", city: "Van", category: "Dogal Alan", image: "https://upload.wikimedia.org/wikipedia/commons/d/d3/Lake_Van_and_Akdamar_Island.jpg", description: "Turkiye'nin en buyuk golu olan Van Golu, mavi sulari ve Akdamar Adasi'ndaki tarihi kilisesiyle unlu bir dogal guzelliktir.", accommodation: "Van sehir merkezinde ve Akdamar Adasi cevresinde oteller bulunur. Buyuk Van Hotel, Van Kent Hotel ve Akdamar Otel konaklama icin uygun seceneklerdir." },
            { id: 19, name: "Nemrut Dagi", city: "Adiyaman", category: "Arkeoloji", image: "https://upload.wikimedia.org/wikipedia/commons/f/fc/ADIYAMAN_NEMRUT_DA%C4%9EI.jpg", description: "Kommagene Kralligi'na ait dev heykellerin bulundugu Nemrut Dagi, gun dogumu ve batimi manzarasiyla unlu bir antik alandir.", accommodation: "Nemrut Dagi cevresinde Kahta ilcesinde oteller bulunur. Nemrut Hotel, Euphrat Hotel ve Kahta Hotel konaklama icin uygun noktalardir." },
            { id: 20, name: "Ishak Pasa Sarayi", city: "Agri", category: "Tarihi Yapi", image: "https://upload.wikimedia.org/wikipedia/commons/e/e8/Ishak_Pasha_Palace.jpg", description: "Osmanli ve Iran mimarisinin harmanlandigi Ishak Pasa Sarayi, Dogu Anadolu'nun en gorkemli yapilarindan biridir.", accommodation: "Sarayin bulundugu Dogubeyazit ilcesinde Tahran Otel, Dogubeyazit Otel ve Isfahan Otel gibi konaklama secenekleri mevcuttur." }
        ]
    },
    {
        name: "Guneydogu Anadolu", icon: "??",
        places: [
            { id: 21, name: "Balikligol", city: "Sanliurfa", category: "Tarihi Yapi", image: "https://images.pexels.com/photos/17708588/pexels-photo-17708588.jpeg", description: "Hz. Ibrahim'in atese atildigi yer olarak bilinen Balikligol, icindeki kutsal baliklari ve cevresindeki tarihi yapilariyla unludur.", accommodation: "Sanliurfa merkezde Balikligol'e yurume mesafesinde oteller bulunur. Edessa Hotel, Harran Hotel ve Hilton Garden Inn Urfa uygun seceneklerdir." },
            { id: 22, name: "Hasankeyf", city: "Batman", category: "Arkeoloji", image: "https://upload.wikimedia.org/wikipedia/commons/8/8f/Hasankeyf.JPG", description: "Dicle Nehri kiyisinda binlerce yillik tarihe sahip Hasankeyf, magara evleri ve tarihi koprusuyle essiz bir acik hava muzesidir.", accommodation: "Hasankeyf'te butik oteller ve Batman merkezde konaklama secenekleri bulunur. Hasankeyf Otel ve Batman Otel tercih edilebilir." },
            { id: 23, name: "Mardin", city: "Mardin", category: "Tarihi Yapi", image: "https://upload.wikimedia.org/wikipedia/commons/6/67/View_from_Mardin_to_the_Mesopotamian_plains.jpg", description: "Tas evleri, dar sokaklari ve Mezopotamya ovasina bakan essiz manzarasiyla Mardin, acik hava muzesi gibidir.", accommodation: "Mardin'de tarihi tas ev butik oteller populer. Mardin House Otel, Cercis Otel, Kasr-1 Mardin Otel ve Seyr-i Mardin otantik bir konaklama deneyimi sunar." }
        ]
    }
];

const holidays = [
    { id: 101, name: "Oludeniz", city: "Fethiye / Mugla", region: "Ege", image: "https://upload.wikimedia.org/wikipedia/commons/6/6f/Oludeniz_%E2%80%93_Blue_lagoon.jpg", description: "Turkuaz rengi denizi ve belcekiz plajiyla dunyanin en guzel sahillerinden biri.", accommodation: "Oludeniz'de her butceye uygun otel ve pansiyon bulunur." },
    { id: 102, name: "Kemer", city: "Antalya", region: "Akdeniz", image: "https://upload.wikimedia.org/wikipedia/commons/d/de/Kemer_beach%2C_Antalya.jpg", description: "Toros daglariyla cevrili muhtesem koylari ve plajlariyla unlu bir tatil beldesi.", accommodation: "Kemer'de her seviyede otel mevcuttur." },
    { id: 103, name: "Marmaris", city: "Mugla", region: "Ege", image: "https://upload.wikimedia.org/wikipedia/commons/9/91/Marmaris%2C_Turkey._Photo_2021.jpg", description: "Camlari, marinasý ve hareketli gece hayatiyla unlu olan Marmaris.", accommodation: "Marmaris'te her butceye uygun otel vardir." },
    { id: 104, name: "Cesme", city: "Izmir", region: "Ege", image: "https://upload.wikimedia.org/wikipedia/commons/2/2f/%C3%87e%C5%9Fme_Strand.jpg", description: "Turkuaz sahilleri, termal sulari ve ruzgar sorfuyle unlu olan Cesme.", accommodation: "Cesme'de butik oteller ve tatil koyleri bulunur." },
    { id: 105, name: "Side", city: "Antalya", region: "Akdeniz", image: "https://upload.wikimedia.org/wikipedia/commons/8/8e/Roman_Amphitheatre%2C_Side%2C_Turkey.jpg", description: "Antik kent kalintilariyla ic ice olan sahil seridi.", accommodation: "Side'de cok sayida her seviyede otel bulunur." },
    { id: 106, name: "Kusadasi", city: "Izmir / Aydin", region: "Ege", image: "https://upload.wikimedia.org/wikipedia/commons/1/1d/Kusadasi.jpg", description: "Turistik canliligi, plajlari ve Efes Antik Kenti'ne yakýnligiyla unlu.", accommodation: "Kusadasi'nda lüks oteller ve butik pansiyonlar mevcuttur." },
    { id: 107, name: "Bodrum", city: "Mugla", region: "Ege", image: "https://upload.wikimedia.org/wikipedia/commons/5/56/Bodrum%2C_Mu%C4%9Fla_Province%2C_Turkey_-_panoramio_%2844%29.jpg", description: "Beyaz badanali evleri, lüks marinalari ve turkuaz sahilleriyle gozde tatil noktasi.", accommodation: "Bodrum'da dunyaca unlu oteller bulunur." },
    { id: 108, name: "Alanya", city: "Antalya", region: "Akdeniz", image: "https://upload.wikimedia.org/wikipedia/commons/7/7b/Alanya_Panorama_edit.jpg", description: "Kalesi, Kleopatra plaji ve dogal guzellikleriyle popüler tatil merkezi.", accommodation: "Alanya'da her butceye uygun binlerce otel bulunur." },
    { id: 109, name: "Fethiye", city: "Mugla", region: "Ege", image: "https://upload.wikimedia.org/wikipedia/commons/7/75/Fethiye_harbour_%281092663484%29.jpg", description: "Koylari, ada turlari ve dogal guzellikleriyle ideal tatil noktasi.", accommodation: "Fethiye'de her seviyede konaklama secenegi vardir." },
    { id: 110, name: "Kas", city: "Antalya", region: "Akdeniz", image: "https://upload.wikimedia.org/wikipedia/commons/4/41/Ka%C5%9F%2C_Patara_Antik_Kenti_Park%C4%B1.jpg", description: "Sakin atmosferi, dalýþ noktalari ve butik otelleriyle huzurlu tatil.", accommodation: "Kas'ta butik oteler ve pansiyonlar bulunur." }
];
...
const botResponses = [
    ...
    { keywords: ["yemek", "yemek", "restoran", "ne yenir", "meþhur"], reply: "Her bolgenin kendine has lezzetleri var! Ege'de otlu peynir, Karadeniz'de hamsi, Guneydogu'da kebap ve baklava, Ic Anadolu'da mantý." },
